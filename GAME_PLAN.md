...
| Sonraki görev | `P3.5` Sözleşme teklif puanı ile sınırlı teminat uzlaşmasını uygula |
| Kodlama durumu | D-031, sunucu-otoriteli teklif snapshot'ı, teminat ve P4'e bırakılan başarısızlık analiz sınırını sabitler; dar teklif uzlaşması uygulanabilir |
...
- [ ] **P3.5** Sözleşme teklif puanı ile sınırlı teminat uzlaşmasını uygula; kaynak üreten başarısızlık analiz ödülünü P4.7'ye bırak.
